...
<div class="max-w-4xl">
    ...
    <div class="mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-800 mb-2">Tambah Artikel Baru</h2>
        <p class="text-gray-600">Buat konten berita atau kegiatan untuk website WPI</p>
    </div>
        ...
        <form action="{{ route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
            ...
            <div>
                ...
                <input 
                    ...
                    required
                >
                <p class="mt-2 text-sm text-gray-500">Buat judul yang menarik dan deskriptif</p>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <label class="relative cursor-pointer">
                        <input type="radio" name="type" value="berita" class="peer sr-only" checked>
                        <div class="p-5 border-2 border-gray-200 rounded-xl peer-checked:border-tosca-500 peer-checked:bg-tosca-50 transition-all hover:border-tosca-300">
                            <div class="flex items-center gap-3 mb-2">
                                <div class="w-10 h-10 bg-tosca-100 rounded-lg flex items-center justify-center text-tosca-600 peer-checked:bg-tosca-500 peer-checked:text-white">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-tosca-500 transition-colors">
                    ...
                    <label for="thumbnail" class="cursor-pointer">
                        ...
                        <div id="upload-prompt">
                            ...
                            <p class="text-gray-700 font-semibold mb-1">Klik untuk upload gambar</p>
                            <p class="text-sm text-gray-500">PNG, JPG maksimal 5MB</p>
                        </div>
                    </label>
                </div>
                <p class="mt-2 text-sm text-gray-500">Resolusi yang disarankan: 1200x630 px</p>
            </div>
            ...
            <div>
                ...
                <textarea 
                    name="content" 
                    rows="12" 
                    class="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-tosca-500 focus:ring-4 focus:ring-tosca-100 transition-all font-mono text-sm"
                    placeholder="Tulis konten artikel di sini...&#10;&#10;Tips:&#10;- Gunakan paragraf untuk memudahkan pembacaan&#10;- Tambahkan detail yang relevan&#10;- Periksa ejaan sebelum menyimpan"
                ></textarea>
                <p class="mt-2 text-sm text-gray-500">Tulis konten yang informatif dan mudah dipahami</p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                <button 
                    ...
                    <i class="fa-solid fa-check mr-2"></i>Simpan Artikel
                </button>
                <a 
    ...
    <div class="mt-6 bg-gradient-to-br from-tosca-50 to-sunshine-50 rounded-2xl p-6 border border-tosca-100">
        <div class="flex items-start gap-4">
            ...
            <div>
                <h4 class="font-bold text-gray-800 mb-2">Tips Membuat Artikel Berkualitas</h4>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-start gap-2">
                        <i class="fa-solid fa-circle-check text-tosca-500 mt-0.5 flex-shrink-0"></i>
                        <span>Gunakan judul yang jelas dan menarik perhatian pembaca</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <i class="fa-solid fa-circle-check text-tosca-500 mt-0.5 flex-shrink-0"></i>
                        <span>Pilih gambar thumbnail yang relevan dan berkualitas tinggi</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <i class="fa-solid fa-circle-check text-tosca-500 mt-0.5 flex-shrink-0"></i>
                        <span>Tulis konten yang informatif dengan bahasa yang mudah dipahami</span>
                    </li>
                </ul>
            </div>
        </div>
